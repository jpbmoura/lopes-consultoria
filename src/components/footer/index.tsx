...
export default function Footer() {
  return (
    <footer id="contact" className="w-full py-6 bg-zinc-800 text-white">
      <div className="container px-4 md:px-6 m-auto">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Sobre Nós</h3>
            <p className="text-sm">
              Transformando vida através de treinos estratégicos.
            </p>
          </div>
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Contato</h3>
            <p className="text-sm">Email: lopesfitcontato@gmail.com</p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex space-x-4">
              <a
                target="_blank"
                href="https://www.instagram.com/lopesfit.oficial/"
          ...
          <Image
            ...
            alt="logo"
            height={64}
            className="md:items-end hidden md:flex"
          />
        </div>
      </div>
    </footer>
